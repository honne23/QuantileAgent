...
import wandb
atari_name = 'DemonAttack'
wandb.init(project="final_evals", name=f'Quantile-{atari_name}')
...
for frame_idx in range(1, num_frames + 1):
    ...
    if frame_idx % plotting_interval == 0:
        _plot(frame_idx - min_train, scores, losses) #epsilons
